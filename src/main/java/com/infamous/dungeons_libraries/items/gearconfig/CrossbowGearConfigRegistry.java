...
public class CrossbowGearConfigRegistry {
    ...
    public static final CodecJsonDataManager<BowGearConfig> GEAR_CONFIGS = new CodecJsonDataManager<>("gearconfig/crossbow", BowGearConfig.CODEC, DungeonsLibraries.LOGGER);
