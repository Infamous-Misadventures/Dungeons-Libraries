...
public class ArmorGearConfigRegistry {
    ...
    public static final CodecJsonDataManager<ArmorGearConfig> GEAR_CONFIGS = new CodecJsonDataManager<>("gearconfig/armor", ArmorGearConfig.CODEC, DungeonsLibraries.LOGGER);


    public static ArmorGearConfig getConfig(ResourceLocation resourceLocation) {
        return GEAR_CONFIGS.data.getOrDefault(resourceLocation, ArmorGearConfig.DEFAULT);
    }
